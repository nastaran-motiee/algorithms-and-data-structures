...
in both. For example, for sets A = {1, 2, 3} and B = {2, 3, 4}, A △ B = {1, 4}.
...
elements (A △ B △ C), you must complete one operation at a time. Thus, for sets A 
and B above, and C = {2, 3}, A △ B △ C = (A △ B) △ C = {1, 4} △ {2, 3} = {1, 2, 3, 4}.
...
function sym(args) {
  //Create a One dimmention array without duplicates
  const arr = [...new Set([...arguments].flat())];
